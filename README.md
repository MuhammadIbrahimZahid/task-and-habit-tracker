...
To enable detailed console logging in development:

Set NEXT_PUBLIC_ENABLE_LOGGING=true to enable logging.

Set NEXT_PUBLIC_ENABLE_LOGGING=false or remove the setting to disable all console logs for security.
